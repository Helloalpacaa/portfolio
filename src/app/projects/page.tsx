...
const projects = [
  {
    ...
    description:
      "A modern e-commerce platform built with React and TypeScript, featuring a responsive design and shopping cart functionality.",
    stack: [
      { name: "React" },
      { name: "TypeScript" },
      { name: "Tailwind CSS" },
  ...
  },
  {
    ...
    description:
      "A collaborative task management application with real-time updates, user authentication, and project organization features.",
    stack: [{ name: "Next.js" }, { name: "PostgreSQL" }, { name: "Node.js" }],
  ...
  },
  {
    ...
    title: "Weather App",
    description:
      "A mobile-responsive weather application that provides real-time weather data and forecasts using external APIs.",
    stack: [
      { name: "React Native" },
